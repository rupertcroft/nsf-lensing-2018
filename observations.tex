...
\begin{figure}[h]
\begin{center}
 \includegraphics[width=0.4\columnwidth]{figs/eBOSS.eps}
 \includegraphics[width=0.4\columnwidth]{figs/CLAMATO.eps}
\end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.25]{figs/GRP_512_15_z1.png}
    \includegraphics[scale=0.25]{figs/GRP_512_15_z1_Recov.png}
  \end{center}
  \caption{ \footnotesize
