...
\vec\theta\,\frac{\theta_E^2}{\theta^2}. \ee For a lens a typical distance of 1 Gpc from us,
...
w(\theta) = 0.36 \left( \frac{1'}{\theta} \right)^{0.8} \,
\frac{0.1}{\Delta z}.\eql{wlsst} \ee As an estimate of the current
capabilities, we take the source galaxies in DES  redshift bin
$0.6<z<0.9$ with number density 1.5 per square arcminute. As
a sanity check, the slope and amplitude in \ec{wlsst} are consistent
